...
namespace salesTrack.Persistence.Migrations
{
    ...
    [Migration("20241022103533_TimeSheetAdded")]
            ...
            modelBuilder.Entity("SalesTrack.Domain.Entities.MasterUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e92e30af-5885-4631-91b3-96eae3185100"),
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 10, 22, 16, 5, 29, 945, DateTimeKind.Unspecified).AddTicks(2954), new TimeSpan(0, 5, 30, 0, 0)),
                            Email = "ramrk@anterntech.com",
                            IsActive = false,
                            IsPasswordTemporary = true,
                            Name = "Ram",
                            Password = "jYl5oK4VFzS1DBtVsT492rxDU9tGGZk44vA+l1xZ3TE=",
                            PhoneNumber = "6545454543",
                            ResetCode = 12345,
                            ResetExpiry = new DateTimeOffset(new DateTime(2024, 10, 22, 10, 50, 29, 945, DateTimeKind.Unspecified).AddTicks(3016), new TimeSpan(0, 0, 0, 0, 0)),
                            Salt = "KohMQK7FloX33hjBEeyd3w==",
                            UserRole = (byte)1
                        });
                });
