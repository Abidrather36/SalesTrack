...
namespace salesTrack.Persistence.Migrations
{
    ...
    [Migration("20240826063918_relationshipBetweenUserandLead")]
    partial class relationshipBetweenUserandLead
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SalesTrack.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b02df487-abd6-4848-8133-f04b6998218e"),
                            Email = "ramrk@anterntech.com",
                            IsActive = false,
                            IsPasswordTemporary = true,
                            Name = "Ram",
                            Password = "hd3IZI8XhKpIpSv4rVR+9xW7onwLHbmhjwbKMLreR+s=",
                            PhoneNumber = "6545454543",
                            ResetCode = 12345,
                            ResetExpiry = new DateTimeOffset(new DateTime(2024, 8, 26, 6, 54, 18, 120, DateTimeKind.Unspecified).AddTicks(8058), new TimeSpan(0, 0, 0, 0, 0)),
                            Salt = "mPou+BYCJAK0txiBzLUGtw==",
                            UserRole = (byte)1,
                            UserType = (byte)0
                        });
                });
