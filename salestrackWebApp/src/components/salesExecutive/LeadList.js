...
//   // Function to handle fetching follow-up history
...
//     try {
//       setLoading(true);
//       const response = await leadFollowUpHistory(lead.id);  // Fetch follow-up history from service
//       if (response.success) {
//         setFollowUpHistory(response.data);  // Assuming response contains a 'data' field with the history
//       } else {
