...
//             onChange={(e) => handleDateSelect(e.value)}
//             showIcon
//             dateFormat="dd/mm/yy" // Ensuring the date format here for the calendar
//           />
//         </div>
...
//                 showIcon
//                 panelClassName="modal-calendar"
//                 dateFormat="dd/mm/yy" // Ensuring the format here for the modal calendar as well
//               />
//               {errors.date && <span className="text-danger">{errors.date.message}</span>}
//             </div>
...
//                 ))}
//               </Select>
//               {errors.processStep && <FormHelperText error>{errors.processStep.message}</FormHelperText>}
//             </FormControl>
...
//               boxShadow: 24,
//               p: 4,
//               zIndex: 1300,  // Ensure the modal stays above other content
//             }}
//             component="form"
//             onSubmit={handleSubmit(onSubmit)}
//           >
...
//                 {...register("date", { required: true })}
//                 showIcon
//                 panelClassName="modal-calendar" // Add custom class name for styling
//                 dateFormat="dd/mm/yy" // Ensuring the format here for the modal calendar as well
//                 inputStyle={{ zIndex: 1500 }}  // Ensure input field appears above the modal
//                 panelStyle={{ zIndex: 2000 }} // Ensure calendar panel appears above the modal
//               />
//               {errors.date && <span className="text-danger">{errors.date.message}</span>}
//             </div>
